...
const GoldenHour = ({space}) => {
  return ( 
    <div className={`${space && 'col-span-2'} hover:shadow-md hover:shadow-yellow-500 text-black cursor-pointer bg-white min-w-fit space-y-4 ring-1 w-full p-2 rounded-xl hover:scale-105  transition-all  flex flex-col items-center duration-[5s]`}>
